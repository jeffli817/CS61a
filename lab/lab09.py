...
def inc_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = subseq_helper(s[1:],prev) #exclude
            b = subseq_helper(s[1:],s[0]) #include
...
def deep_len(lnk):
    ...
    #link empty =0
    #lnk not = only integer = not instance =1
    # count both first and rest
