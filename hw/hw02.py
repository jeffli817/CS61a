...
def pingpong(n):
    ...
    def helper(index,value,direction):
        if index==n:
            ...
            return helper(index+1,value+direction*-1,direction*-1)
        else:
...
def missing_digits(n):
    ...
    if n<=0:
        return 0
    elif n%10 == n//10%10 or n%10-1 == n//10%10:
...
def count_coins(total):
    ...
    def helper(coin,value):
        if coin == None:
            ...
            add_coin = helper(next_largest_coin(coin),value)
            no_add_coin = helper(coin,value-coin)
            return add_coin+no_add_coin
